<?php
    ...
    if(isset($_POST['add_content'])){
        ...
        if(empty($msg)){
            ...
            $_SESSION['msg'] = 'Content Add Successfully';
...
<!-- End Header Add content  -->

<div class="row py-3"></div>


<!-- Start Content Add content  -->
    <div class="row pb-2">
        <form class="bg-dark p-3 rounded" action="?page=content&add" method="POST" enctype="multipart/form-data">
            <div class="row">
