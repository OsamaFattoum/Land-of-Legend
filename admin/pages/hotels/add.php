<?php
    ...
    if(isset($_POST['add_hotel'])){
        ...
        if(empty($msg)){
            ...
            $_SESSION['msg'] = 'Hotel Add Successfully';
...
<!-- End Header Add Hotel  -->

<div class="row py-3"></div>


<!-- Start Content Add Hotel  -->
    <div class="row pb-2">
        <form class="bg-dark p-3 rounded" action="?page=hotels&add" method="POST" enctype="multipart/form-data">
            <div class="row">
            ...
            <div class="row">
                <div class="mb-3 col-lg-6">
                    <label for="inputcountry" class="form-label  text-white">Star</label>
